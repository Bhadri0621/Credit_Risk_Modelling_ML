...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd,
...
def predict(age, income, loan_amount, loan_tenure_months, avg_dpd,
                    delinquent_ratio, credit_utilization_ratio, num_open_accounts, residence_type,
                    loan_purpose, loan_type):

    input_df=prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd,
                    delinquent_ratio, credit_utilization_ratio, num_open_accounts, residence_type,
                    loan_purpose, loan_type)
